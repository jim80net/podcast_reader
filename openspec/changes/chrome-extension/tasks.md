...
- [x] 2.5 Diagnostic/log sweep: assert jar content and pairing codes excluded from engine logs and any diagnostic surface; Python gates (pytest, mypy strict, ruff check+format)
