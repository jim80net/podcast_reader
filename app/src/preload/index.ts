...
const api: PodcastReaderApi = {
  ...
  listSubscriptions: () => ipcRenderer.invoke(CHANNELS.subscriptionsList),
  createSubscription: (feedUrl) => ipcRenderer.invoke(CHANNELS.subscriptionsCreate, feedUrl),
  pollSubscription: (subscriptionId) => ipcRenderer.invoke(CHANNELS.subscriptionsPoll, subscriptionId),
  deleteSubscription: (subscriptionId) => ipcRenderer.invoke(CHANNELS.subscriptionsDelete, subscriptionId),
  getSubscriptionEmailPreference: (subscriptionId) => ipcRenderer.invoke(CHANNELS.emailPreferenceGet, subscriptionId),
  setSubscriptionEmailPreference: (subscriptionId, enabled) => ipcRenderer.invoke(CHANNELS.emailPreferenceSet, subscriptionId, enabled),
  createManualEmail: (sourceId) => ipcRenderer.invoke(CHANNELS.emailManualCreate, sourceId),
  listEmailDeliveries: () => ipcRenderer.invoke(CHANNELS.emailOutboxList),
